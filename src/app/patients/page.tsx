      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <form method="GET" className="mb-6">
          <input
            name="q"
            defaultValue={q}
            placeholder-gray-400="Buscar paciente pelo nome..."
            className="w-full border border-gray-400 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
          />
        </form>
