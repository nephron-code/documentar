  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center gap-1.5 text-sm text-red-600 hover:text-red-800 border border-red-200 hover:border-red-400 bg-white px-3 py-1.5 rounded-lg transition-colors"
      >
