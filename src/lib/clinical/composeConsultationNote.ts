...
/**
 * Compõe a nota de consulta estruturada para colar no prontuário externo.
 *
 ...
 * — Últimos exames no topo para leitura rápida
 * — Histórico longitudinal abaixo para rastreio de tendência
 *
 * Ferramenta de apoio — o médico revisa antes de colar no sistema oficial.
 */
export function composeConsultationNote(
  patient: PatientData,
 ...
 */
export function composeCompactSummary(
  patient: PatientData,
  evolution: EvolutionData,
  labResults: LabResultData[]
): string {
